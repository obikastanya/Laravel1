        ...
        <div class="tab-pane fade show active bg" id="pills-home" role="tabpanel" aria-labelledby="home">
            <div class="row">
                <div class="col-sm-9 home-landing align-middle">
                    ...
                    <!--  -->
                    <a class="btn btn-primary login-guru" href="/login" role="button">Login Guru Disini</a>
                    <section>
                ...
                <div class="col-sm-12 align-middle">
                    ...
                    <form class="form-inline">
                        <div class="form-group mx-sm-3 mb-2">
                            ...
                            <input type="date" class="form-control" id="tgl_lahir" placeholder="Masukin Tanggal Lahir">
                        </div>
